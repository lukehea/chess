...
public class GameBoard {
	...
	protected Color boardColor1 = Color.WHITE;
	protected Color boardColor2;
	...
	protected boolean columnBorder;
	protected double outerBorderWeight = 10;
	protected double innerBorderWeight = 10;
	protected double cellHeight;
	protected double cellWidth;
	protected int[] lastCoordinates = {-1, -1};
